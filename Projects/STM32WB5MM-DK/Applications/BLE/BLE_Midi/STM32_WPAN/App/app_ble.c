...
{
  3, AD_TYPE_COMPLETE_LOCAL_NAME, 'W', 'B',  /* Complete name */
  17, AD_TYPE_128_BIT_SERV_UUID_CMPLT_LIST, 0x00, 0xC7, 0xC4, 0x4E, 0xE3, 0x6C, 0x51, 0xA7, 0x33, 0x4B, 0xE8, 0xED, 0x5A, 0x0E, 0xB8, 0x03,
...
void APP_BLE_Key_Button1_Action(void)
{
  ...
  if(tick - prevTick > DEBOUNCE_TIME)
  {
    Midi_Button_Restart();
    prevTick=tick;
  }
